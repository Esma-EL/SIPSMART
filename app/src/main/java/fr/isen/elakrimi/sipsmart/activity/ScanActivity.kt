...
import fr.isen.elakrimi.sipsmart.screen.BLEDevice
import fr.isen.elakrimi.sipsmart.screen.ScanScreen
import fr.isen.elakrimi.sipsmart.FirebaseAuthViewModel // Assure-toi que ce fichier existe
...
class ScanActivity : ComponentActivity() {
    ...
    private fun launchScanUI() {
        ...
        setContent {
            val viewModel = FirebaseAuthViewModel() // à remplacer par hiltViewModel() si tu utilises Hilt
            ...
            SIPSMARTTheme {
                ScanScreen(
                    ...
                    onConnectClick = {
                        // Exemple : tu pourrais démarrer une autre activité ici
